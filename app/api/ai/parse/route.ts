...
Quadrant criteria:
- urgent-important: deadline/time pressure AND high importance or consequences
- not-urgent-important: no immediate deadline but significant long-term value
- urgent-not-important: time-sensitive but low importance
- not-urgent-not-important: no urgency and low importance`,
      },
      {
        role: "user",
        content: text,
